...
def create_PaviaCentre():
    ...
    create_lmdb_train(
        datadir, fns, 'your_path', 'hsi',  # your own dataset address
        crop_sizes=None,
        scales=(1,),
        ksizes=(101, 64, 64),
        strides=[(101, 32, 32)],
...
def create_icvl64_31():
    ...
    datadir = 'your_path' # your own data address
    fns = os.listdir(datadir) 
    fns = [fn.split('.')[0]+'.mat' for fn in fns]
    
    create_lmdb_train(
        datadir, fns, 'your_path', 'rad',  # your own dataset address
...
def create_cave64_31_2():
    ...
    create_lmdb_train(
        datadir, fns, 'your_path', 'DataCube',  # your own dataset address
        crop_sizes=None,
        scales=(1, 0.5, 0.25),        
        ksizes=(31, 64, 64),
...
def create_houston64_stride_24_46():
    ...
    create_lmdb_train(
        datadir, fns, 'your_path', 'houston',  # your own dataset address
        crop_sizes=None,
        scales=(1, 0.5, 0.25),        
        ksizes=(46, 64, 64),
        strides=[(10, 24, 24), (5, 12, 12), (5, 12, 12)],   
