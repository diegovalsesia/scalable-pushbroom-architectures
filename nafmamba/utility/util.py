...
if __name__ == '__main__':
    ...
    # visualize('your_path', 'inputs', load=h5py.File, preprocess=None)
    ...
    # visualize('your_path', 'hsi', load=loadmat, preprocess=preprocess)
    # visualize('your_path', 'true_hr', load=loadmat, preprocess=preprocess)

    # visualize('your_path', 'hsi', load=loadmat, preprocess=preprocess)
    # visualize('your_path', 'R_hsi', load=loadmat, preprocess=preprocess)
    # visualize('your_path', 'input', load=loadmat, preprocess=preprocess)
