...
class BaseModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if self.lr_scheduler is not None:
            if self.lr_scheduler.class_name in torch.optim.lr_scheduler.__dict__:
                scheduler_class = torch.optim.lr_scheduler.__dict__[self.lr_scheduler.class_name]
            elif 'LinearWarmupCosineAnnealingLR'== self.lr_scheduler.class_name:
                scheduler_class = LinearWarmupCosineAnnealingLR
                logger.debug(f"Using {scheduler_class} scheduler")
